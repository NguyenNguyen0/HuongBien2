...
import huongbien.service.PromotionBUS;
...
public class PromotionManagementController implements Initializable {
    ...
    public PromotionManagementController() throws RemoteException {
    }
    ...
    public void setPaginationGetByStatus() {
        try {
            ...
            promotionPagination = new Pagination<>(
                    (offset, limit) -> {
                        try {
                            return promotionBUS.getPromotionByStatusWithPagination(offset, limit, status);
    ...
    public void setPaginationSearchById() {
        try {
            ...
            promotionPagination = new Pagination<>(
                    (offset, limit) -> {
                        try {
                            return promotionBUS.getPromotionByIdWithPagination(offset, limit, id);
                        } catch (RemoteException e) {
                            throw new RuntimeException(e);
                        }
                    },
    ...
    public void onFilterPromotionStatusComboBoxSelected(ActionEvent actionEvent) {
        ...
        try {
            promotionPagination.setCurrentPage(
                    (offset, limit) -> {
                        try {
                            return promotionBUS.getPromotionByStatusWithPagination(offset, limit, statusFilter);
                        } catch (RemoteException e) {
                            throw new RuntimeException(e);
                        }
                    },
