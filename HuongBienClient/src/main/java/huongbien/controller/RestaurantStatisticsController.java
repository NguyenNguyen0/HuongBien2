...
import huongbien.service.CategoryBUS;
import huongbien.service.CuisineBUS;
import huongbien.service.EmployeeBUS;
import huongbien.service.StatisticsBUS;
...
//        Employee statistical
    ...
    private void setBusinessSummary() {
        try {
            IStatisticsDAO statisticsDAO = RMIClient.getInstance().getStatisticsDAO();
...
//    END: REVENUE STATISTICAL
    ...
    public void setCuisineComboBox() {
        CuisineBUS cuisineBUS = null;
        try {
            cuisineBUS = new CuisineBUS();
