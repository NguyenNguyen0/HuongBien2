...
public class RestaurantLookupController implements Initializable {
    ...
    public RestaurantLookupController() throws RemoteException {
    }
    ...
    private void setValueCuisineComboBox() throws RemoteException {
    ...
    private void setValueTableComboBox() throws RemoteException {
        // Lấy danh sách tầng
    ...
    private void setValuePromotionComboBox() throws RemoteException {
    ...
    private void setTableViewColumn() throws RemoteException {
            ...
            case "Bàn":
                ...
                if (tableList.isEmpty()) {
                    ...
                    tableTypeColumn.setCellValueFactory(cellData -> {
                        String type = null;
                        try {
                            type = tableTypeBUS.getTableTypeName(cellData.getValue().getTableType().getId()).getName();
                        } catch (RemoteException e) {
                            throw new RuntimeException(e);
                        }
            ...
            case "Món ăn":
                ...
                if (cuisineList.isEmpty()) {
                    ...
                    cuisineCountSaleColumn.setCellValueFactory(cellData -> {
                        int countOfUnitsSold = 0;
                        try {
                            countOfUnitsSold = orderDetailBUS.getCountOfUnitsSold(cellData.getValue().getId());
                        } catch (RemoteException e) {
                            throw new RuntimeException(e);
                        }
            ...
            case "Đơn đặt trước":
                ...
                if (reservationList.isEmpty()) {
                    ...
                    reservationCustomerPhoneColumn.setCellValueFactory(cellData -> {
                        String phone = null;
                        try {
                            phone = customerBUS.getCustomer(cellData.getValue().getCustomer().getId()).getId();
                        } catch (RemoteException e) {
                            throw new RuntimeException(e);
                        }
    ...
    private void setDefaultTableView() throws RemoteException {
    ...
    //---
    @FXML
    void onRestaurantLookupComboBoxAction(ActionEvent event) throws RemoteException {
        String selectedItem = restaurantLookupComboBox.getValue();
        restaurantLookupCuisineVBox.setVisible(false);
        restaurantLookupPreOrderTableVBox.setVisible(false);
        restaurantLookupPromotionVBox.setVisible(false);
    ...
    @FXML
    void onTableNameTextFieldKeyReleased(KeyEvent keyEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onClearTableNameMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        tableNameTextField.clear();
    ...
    @FXML
    void onTableFloorComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onTableSeatsComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onTableTypesComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onTableStatusComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onCuisineCategoryComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onCuisineNameTextFieldKeyReleased(KeyEvent keyEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onClearCuisineNameMouseClicked(MouseEvent mouseEvent) throws RemoteException {
    ...
    @FXML
    void onPromotionNameTextFieldKeyReleased(KeyEvent keyEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onClearPromotionNameMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        promotionNameTextField.clear();
    ...
    @FXML
    void onPromotionStartDateAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onPromotionEndDateAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onCLearPromotionStartDateMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        promotionStartDate.setValue(null);
        setTableViewColumn();
    }

    @FXML
    void onCLearPromotionEndDateMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        promotionEndDate.setValue(null);
        setTableViewColumn();
    }

    @FXML
    void onPromotionDiscountComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onPromotionMinimumOrderAmountComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onPromotionStatusComboBoxAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onReservationIdTextFieldKeyReleased(KeyEvent keyEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onClearReservationIdButtonMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        reservationIdTextField.clear();
    ...
    @FXML
    void onReservationCustomerPhoneTextFieldKeyReleased(KeyEvent keyEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onCLearReservationCustomerPhoneMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        reservationCustomerPhoneTextField.clear();
    ...
    @FXML
    void onReservationDateAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onReservationReceiveDateAction(ActionEvent actionEvent) throws RemoteException {
        setTableViewColumn();
    }

    @FXML
    void onReservationDateMouseClicked(MouseEvent mouseEvent) throws RemoteException {
        reservationDate.setValue(null);
        setTableViewColumn();
    }

    @FXML
    void onClearReceiveDateMouseClicked(MouseEvent mouseEvent) throws RemoteException {
