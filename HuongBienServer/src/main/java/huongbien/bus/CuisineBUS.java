...
public class CuisineBUS {
    ...
    public List<Cuisine> getAllCuisine() throws RemoteException { return cuisineDao.getAll(); }

    public List<Cuisine> getLookUpCuisine(String name, String category, int pageIndex) throws RemoteException { return cuisineDao.getLookUpCuisine(name, category, pageIndex); }

    public int getCountLookUpCuisine(String name, String category) throws RemoteException { return cuisineDao.getCountLookUpCuisine(name, category); }
    ...
    public  List<String> getCuisineCategory() throws RemoteException { return cuisineDao.getCuisineCategory();}
