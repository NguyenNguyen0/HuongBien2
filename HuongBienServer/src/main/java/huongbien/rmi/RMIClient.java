...
public class RMIClient {
     ...
     */
    public IStatisticsDAO getStatisticDAO() throws RemoteException, NotBoundException {
        ensureConnected();

        try {
            return (IStatisticsDAO) registry.lookup("statisticDAO");
        } catch (RemoteException | NotBoundException e) {
            LOGGER.log(Level.SEVERE, "Failed to get StatisticDAO", e);
            throw e;
        }
    }
